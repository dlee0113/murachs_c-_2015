...
namespace CustomerMaintenance.MMABooksDataSetTableAdapters {
...
SELECT CustomerID, Name, Address, City, State, ZipCode FROM Customers WHERE (CustomerID = @CustomerID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CustomerMaintenance.Properties.Settings.Default.MMABooksConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[2].CommandText = "SELECT CustomerID, Name, Address, City, State, ZipCode FROM dbo.Customers\r\nWHERE " +
                "State = @State";
